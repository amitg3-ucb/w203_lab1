...
df2$`Party Self ID` = ifelse(df2$`Party Self ID` == 1, "D", ifelse(df2$`Party Self ID` == 2, "Ind", ifelse(df2$`Party Self ID` == 3, "R", NA)))
...
df2$`Party Classification` = ifelse(df2$`Party ID` == "D", "D", ifelse(df2$`Party ID` == "R", "R", ifelse(df2$`Party ID` == "Ind", "Ind", ifelse(df2$`Party Lean` == "D", "D", ifelse(df2$`Party Lean` == "R", "R", ifelse(df2$`Party Self ID` == "D", "D", ifelse(df2$`Party Self ID` == "R", "R", ifelse(df2$`Party Self ID` == "Ind", "Ind", ifelse(is.na(df2$`Party Self ID`), "Ind","Ind")))))))))
...
library("ggpubr")
ggboxplot(voter_data, x = "Voting Difficulty", y = "Party Classification", 
          color = "Party Classification", palette = c("#00AFBB", "#E7B800"),
          ylab = "Voting Difficulty", xlab = "Count of Responses")
