...
df2$`Party ID` = ifelse(df2$`Party ID` == 1 | df2$`Party ID` == 2 | df2$`Party ID` == 3, "R", ifelse(df2$`Party ID` == 4, "Ind", ifelse(df2$`Party ID` == 5 | df2$`Party ID` == 6 | df2$`Party ID` == 7, "D", NA)))

df2$`Party Lean` = ifelse(df2$`Party Lean` == 3, "R", ifelse(df2$`Party Lean` == 2, "Ind", ifelse(df2$`Party Lean` == 1, "D", NA)))
df2$`Party Self ID` = ifelse(df2$`Party Self ID` == 1, "R", ifelse(df2$`Party Self ID` == 2, "Ind", ifelse(df2$`Party Self ID` == 3, "D", NA)))
...
df2$`Party Classification` = ifelse(df2$`Party ID` == "D", "D", ifelse(df2$`Party ID` == "R", "R", ifelse(df2$`Party ID` == "D", "D", ifelse(df2$`Party Lean` == "D", "D", ifelse(df2$`Party Lean` == "R", "R", ifelse(df2$`Party Self ID` == "D", "D", ifelse(df2$`Party Self ID` == "R", "R", ifelse(df2$`Party Self ID` == "Ind", "Ind", ifelse(is.na(df2$`Party Self ID`), "Ind","Ind")))))))))
...
```{r}
res <- wilcox.test(dem_data$`Voting Difficulty`, rep_data$`Voting Difficulty`, alternative = "less")
res
```
